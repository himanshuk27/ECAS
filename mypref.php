        ...
        <div class="app-body">
            <div class="sidebar">
                <nav class="sidebar-nav">
                    <ul class="nav">
                       <li class="nav-item">
                        <a class="nav-link" href="pref.php"><i class="icon-puzzle"></i>Subjects</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="MYpref.php"><i class="icon-puzzle"></i>My Preferences</a>
                    </li>
         ...
         <div class="row animated fadeIn" id="SelectedSubjectList">
            ...
            <div class="card-block">
                <table class="table">
                    ...
                    <tr>
                    <?php 
                        $query3 = $con->prepare("SELECT * FROM `electives` WHERE SubCode = '".$Sem3Subs[0]."'");
                        $query3->execute();
                        $row3 = $query3->fetch();
                    ?>
         ...
         <div class="row animated fadeIn" id="SelectedSubjectList">
            ...
            <div class="card-block">
                <table class="table">
                    ...
                    <tbody>
                                        <?php 
                        $query4 = $con->prepare("SELECT * FROM `electives` WHERE SubCode = '".$Sem4Subs[0]."'");
                        $query4->execute();
                        $row4 = $query4->fetch();
                    ?>
